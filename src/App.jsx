...
const App = () => {
  ...
  return (
    <main>
      <div className="w-full p-2 md:p-10 lg:p-20 text-gray-100 flex flex-col justify-center items-center gap-10">
      ...
      <footer className="fixed bottom-0 h-16 w-full flex items-center justify-center">
